    ...
    <div className='main'>
      {arr.map((value) => (
        ...
        <Card className={'mycard'} style={{ backgroundColor: '#f2d9d9', marginTop: 20}} variant='outlined' sx={{ maxWidth: '15rem', marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          <CardMedia style={{backgroundColor: '##f2d9d9'}}
          >
            <iframe frameborder="0" allow="autoplay" allowfullscreen="true" style={{ width: '100%', height: '100%' }} src={value.src}></iframe>
          </CardMedia>
          
          <CardActions style={{ justifyContent: 'center', backgroundColor: '#260d0d' }}>
            <Button variant='contained' style={{backgroundColor: '#260d0d'}} size="large" href={value.link}>Download</Button>
