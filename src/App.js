  ...
  return (
    ...
    <div className='main'>
      {arr.map((value) => (
        ...
        <Card className={'mycard'} style={{ backgroundColor: '#602020', marginTop: 20}} variant='outlined' sx={{ maxWidth: '15rem', marginLeft: 'auto', marginRight: 'auto' }}>
          ...
          <CardMedia style={{backgroundColor: '#260d0d'}}
          >
